import uuid
from sqlalchemy import Column, String, Text, Boolean, Numeric, SmallInteger, DateTime, ForeignKey
...
class InternshipPost(Base):
    """Detail table for INTERNSHIP post type"""
    ...
    post = relationship("Post", back_populates="internship")
    address = relationship("Address", back_populates="internship_posts")

    def __repr__(self):
        return f"<InternshipPost(id={self.id}, title={self.title})>"
